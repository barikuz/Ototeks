namespace Ototeks.UI
{
    partial class FrmDashboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            tileItemElement1.Text = "Pending Orders";
            ...
            tileItemElement3.Text = "Critical Stock";
            ...
            tileItemElement5.Text = "Total Customers";
            ...
            // gridView1
            //
            gridView1.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] { colOrderNumber, colCustomerName, colDueDate, colRemainingDays, colStatus });
            ...
            // colOrderNumber
            //
            colOrderNumber.Caption = "Order No";
            ...
            colDueDate.VisibleIndex = 2;
            //
            // colRemainingDays
            //
            colRemainingDays.Caption = "Remaining Days";
            colRemainingDays.FieldName = "RemainingDays";
            colRemainingDays.Name = "colRemainingDays";
            ...
            lblDeliveryAlertsTitle.Text = "Orders with Approaching Due Dates";
            //
            // chartControl1
            //
            ...
            chartTitle1.Text = "Order Distribution by Production Stages";
